<template>
    ...
    <div class="form" id = "formulario">
      <form class="row g-3 needs-validation" novalidate>
        <div class="col-md-4">
          ...
          <input type="text" class="form-control" name="name" id="nombreform" required>
          <div class="valid-feedback">
            Perfecto!
          </div>
          <div class="invalid-feedback">
            Porfavor pon un nombre!
          </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          ...
          <div class="input-group has-validation">
            ...
            <input type="text" class="form-control" name="email" id="correoform" aria-describedby="inputGroupPrepend" required>
            <div class="invalid-feedback">
              Porfavor coloca un correo
            </div>
            <div class="valid-feedback">
              Perfecto!
            </div>
        ...
        <div class="col-md-2">
          ...
          <input type="text" class="form-control" name="edad" id="edadform" required>
          <div class="invalid-feedback">
            Porfavor coloca tu edad!
          </div>
          <div class="valid-feedback">
              Perfecto!
            </div>
        ...
        <div class="col-md-3">
          ...
          <input type="text" name="telefono" class="form-control" id="telefonoform" required>
          <div class="invalid-feedback">
            Porfavor coloca tu telefono
          </div>
          <div class="valid-feedback">
              Perfecto!
            </div>
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="pais" class="form-control" id="paisform" required>
          <div class="invalid-feedback">
            Porfavor coloca tu pais
          </div>
          <div class="valid-feedback">
            Perfecto!
          </div>
        ...
        <div class="col-12">
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="" id="checkboxform" required>
            <label class="form-check-label" for="invalidCheck">
              Acepto las condiciones de contrato
            </label>
            <div class="invalid-feedback">
    ...
    <div class="col-12">
          <button class="btn btn-primary" type="submit" v-on:click="downloadPDF()">GenerarPDF</button>
        </div>
      ...
      .get(this.URL+'hc_completo/'+"1",{
        ...
        .then(response => {
          ...
          this.response.forEach(i => {
              this.mascota.nombre=i.nMascota
              this.mascota.edad=i.eMascota
              this.mascota.tipo=i.tMascota
              this.mascota.raza=i.rMascota
              this.dueno.nombre=i.nombreCliente
              this.dueno.telefono=i.tCliente
              this.dueno.direccion=i.dCliente
          })
          ...
          pdf.text("Datos clinicos de la mascota: "+this.mascota.nombre,10,7);
  pdf.text("Edad: "+this.mascota.edad+" Animal: "+this.mascota.tipo+" Raza: "+this.mascota.raza,20,14);
          pdf.text("Datos Dueño: "+this.dueno.nombre,10,21);
          pdf.text("Telefono: "+this.dueno.telefono,20,28);
          pdf.text("Direccion: "+this.dueno.direccion,20,35);
          ...
          pdf.save("HistorialCLinico"+"nombreMascota");
